...
What is Django ?  [as
per Djangoprojects.com]

·
Django makes it easier to build web apps more
quickly and with less code

·
The web frame work for perfectionist with
deadlines
...
[![](/assets/img/posts/2017-01-07-django-marathon-1-6/1.png)](/assets/img/posts/2017-01-07-django-marathon-1-6/1.png)



[![](/assets/img/posts/2017-01-07-django-marathon-1-6/2.png)](/assets/img/posts/2017-01-07-django-marathon-1-6/2.png)
...
- url.py : reroute url
- views.py  : in Django
  terminology combine data with templates for output
- models.py :  for
  models
