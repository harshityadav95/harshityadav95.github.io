...
![image](/assets/img/posts/2024-06-01-How-Variable-Memory-Works-internally-in-Python/47698935-e7be-4351-adc4-6fc4dd435ce6.png)
...
![image](/assets/img/posts/2024-06-01-How-Variable-Memory-Works-internally-in-Python/580ebb3e-8234-4e61-9c8f-35ded4e3304c.png)

1. PyObject is defined as a struct as C 

![image](/assets/img/posts/2024-06-01-How-Variable-Memory-Works-internally-in-Python/cef0b200-6d50-4dc7-88cc-9fd51bc7605f.png)
...
![image](/assets/img/posts/2024-06-01-How-Variable-Memory-Works-internally-in-Python/f2a1c4db-11d7-4393-b3dd-678aaf4f971f.png)
...
![image](/assets/img/posts/2024-06-01-How-Variable-Memory-Works-internally-in-Python/a6776a9c-7dbd-4e7a-ad66-73fb0ed15feb.png)
...
![image](/assets/img/posts/2024-06-01-How-Variable-Memory-Works-internally-in-Python/f3a97d58-5a11-4c04-ab08-583388156300.png)


1. When del is used in python

![image](/assets/img/posts/2024-06-01-How-Variable-Memory-Works-internally-in-Python/edfe5525-c6a2-42a6-9b14-d7f667702aec.png)


1. Mutable and Immutable Objects in Python

![image](/assets/img/posts/2024-06-01-How-Variable-Memory-Works-internally-in-Python/a85a3cfb-97ac-4dfc-b771-5f41fcad41a9.png)


![Screenshot 2024-06-04 183139](/assets/img/posts/2024-06-01-How-Variable-Memory-Works-internally-in-Python/88b523d0-bdd9-4da8-9090-4e86d9cca262.png)
...
![image](/assets/img/posts/2024-06-01-How-Variable-Memory-Works-internally-in-Python/48994f95-58b3-4b79-a558-3e2426b3d226.png)
...
![image](/assets/img/posts/2024-06-01-How-Variable-Memory-Works-internally-in-Python/a6fde0c5-1850-4896-841e-39eaef90e7ca.png)
...
![image](/assets/img/posts/2024-06-01-How-Variable-Memory-Works-internally-in-Python/b00a9fbc-fb02-46e7-bb0d-2a12f223baee.png)
...
![image](/assets/img/posts/2024-06-01-How-Variable-Memory-Works-internally-in-Python/2835f5de-60cc-4f97-b9ef-8c49e33b07ae.png)


Then, the Internal value pointer is also updated and the memory allocated to the older array is released 

![image](/assets/img/posts/2024-06-01-How-Variable-Memory-Works-internally-in-Python/6593af54-f549-425d-b8e8-ddd5e7e94fad.png)
...
![image](/assets/img/posts/2024-06-01-How-Variable-Memory-Works-internally-in-Python/07e036dc-591a-4ebe-a5a1-e67675ae6628.png)
...
![image](/assets/img/posts/2024-06-01-How-Variable-Memory-Works-internally-in-Python/a2843181-34b6-450b-bfbc-d6fb40a54ca8.png)
...
![image](/assets/img/posts/2024-06-01-How-Variable-Memory-Works-internally-in-Python/877dca39-7c4c-448c-91e3-0a1c3ddb53bd.png)
...
![image](/assets/img/posts/2024-06-01-How-Variable-Memory-Works-internally-in-Python/1fb2bc63-e945-4bf6-b08e-b753386b28d8.png)
...
![image](/assets/img/posts/2024-06-01-How-Variable-Memory-Works-internally-in-Python/b33fda9e-d035-48eb-aa55-81b7e964e3af.png)


## Difference between == and =

![image](/assets/img/posts/2024-06-01-How-Variable-Memory-Works-internally-in-Python/38b16a3a-18e9-4b1c-ab0c-fc554b79408c.png)
...
![image](/assets/img/posts/2024-06-01-How-Variable-Memory-Works-internally-in-Python/45e83786-2d6b-4e2a-ab48-7f0dce0065e3.png)



- Inside the function my_list will point to the new list

![image](/assets/img/posts/2024-06-01-How-Variable-Memory-Works-internally-in-Python/4c602857-5442-4ed9-8ce2-eeaa0fbc6ace.png)
...
![image](/assets/img/posts/2024-06-01-How-Variable-Memory-Works-internally-in-Python/bc51c1a1-041a-4764-b772-c612ba63876e.png)
...
![image](/assets/img/posts/2024-06-01-How-Variable-Memory-Works-internally-in-Python/c9f75284-8cb3-4eb9-9f56-a1d590aeeec4.png)
...
![image](/assets/img/posts/2024-06-01-How-Variable-Memory-Works-internally-in-Python/e72bc2e9-827f-4bff-b422-15d2da765a1a.png)
...
![image](/assets/img/posts/2024-06-01-How-Variable-Memory-Works-internally-in-Python/c59b1d69-8b95-477c-a86d-5f08616c00be.png)
...
![image](/assets/img/posts/2024-06-01-How-Variable-Memory-Works-internally-in-Python/c0fd1e13-8f8c-47bf-915f-d2b96785592e.png)
...
![image](/assets/img/posts/2024-06-01-How-Variable-Memory-Works-internally-in-Python/a47d3ac8-70bd-4ce4-aa8b-40d023569dd8.png)


- Create two variables and check there identity
- Using only + Operator

![image](/assets/img/posts/2024-06-01-How-Variable-Memory-Works-internally-in-Python/d20c4aed-ea63-4cad-93c1-9d1892ed8866.png)
...
![image](/assets/img/posts/2024-06-01-How-Variable-Memory-Works-internally-in-Python/045e6056-271f-467c-bba9-48032413ea2a.png)


Reason for this behavior

![image](/assets/img/posts/2024-06-01-How-Variable-Memory-Works-internally-in-Python/9268e518-57f2-49b3-b000-109b61d888c0.png)
...
![image](/assets/img/posts/2024-06-01-How-Variable-Memory-Works-internally-in-Python/66348161-abde-45e9-a199-56caf0ae16e1.png)
...
![image](/assets/img/posts/2024-06-01-How-Variable-Memory-Works-internally-in-Python/30045e48-abde-41c0-896a-5bb539036d86.png)


- When append is used only list is modified not the tuple

![image](/assets/img/posts/2024-06-01-How-Variable-Memory-Works-internally-in-Python/64ee0916-fe8b-473a-a03f-5f817f224564.png)
