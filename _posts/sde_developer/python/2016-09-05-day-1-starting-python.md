...
As per my Schedule with my friend the target we set for day one for starting of with python was that we would complete 10% of the course percentage at the [Code Academy](https://www.codecademy.com/en/tracks/python) , since the code academy only has instructions about the  code and not about the compiler setup and installation i  turned to on of my favorite youtubers for instructions and found this Getting started with python video more than sufficient of what i needed to begin with
