...
AI agents (including Claude, Gemini, etc.) should treat this file as the source of truth for repository instructions.

This file provides the technical standards and architectural guidance when working in this repository. It defines the "Harshit Writing Style Guide" modeled after Hussein Nasser's pragmatic, "no-nonsense" system design explainer style.
